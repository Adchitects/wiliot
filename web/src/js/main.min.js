...
if (partnersFiltersHld) {
  ...
  var btnResetFilter = partnersFiltersHld.querySelector('.js-partners-filters-reset-btn'); // let activeFilters = [];
  ...
  filterAll.forEach(function (filter) {
    ...
    filter.addEventListener('click', function () {
      if (!isActive) {
        isActive = true;
        filter.classList.add('is-active'); // activeFilters.push(filterDataCategory);
        ...
        isActive = false;
        filter.classList.remove('is-active'); // const filterIndex = activeFilters.indexOf(filterDataCategory);

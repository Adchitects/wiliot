...
/***/ "./web/src/js/libs/lazyLoad.js":
/*!*************************************!*\
  !*** ./web/src/js/libs/lazyLoad.js ***!
  \*************************************/
/*! exports provided: lazyLoadInstance */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lazyLoadInstance", function() { return lazyLoadInstance; });
...
var lazyLoadInstance = new vanilla_lazyload__WEBPACK_IMPORTED_MODULE_0___default.a({
  elements_selector: '.js-lazy' // use_native: false,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scripts_partnersFilters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/partnersFilters */ "./web/src/js/scripts/partnersFilters.js");
/* harmony import */ var _scripts_partnersFilters__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scripts_partnersFilters__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _scripts_buyTilesIcons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/buyTilesIcons */ "./web/src/js/scripts/buyTilesIcons.js");
/* harmony import */ var _scripts_loadMore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/loadMore */ "./web/src/js/scripts/loadMore.js");
/* harmony import */ var _scripts_sliders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/sliders */ "./web/src/js/scripts/sliders.js");
/* harmony import */ var _scripts_doge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/doge */ "./web/src/js/scripts/doge.js");
// SCRIPTS
...
/***/ "./web/src/js/scripts/buyTilesIcons.js":
/*!*********************************************!*\
  !*** ./web/src/js/scripts/buyTilesIcons.js ***!
  \*********************************************/
/*! no exports provided */
...
var tilesHld = document.querySelector('.js-buy-tiles-hld');

if (tilesHld) {
  var tilesAll = tilesHld.querySelectorAll('.js-buy-tiles-item');
  tilesAll.forEach(function (item) {
    var icon = item.querySelector('.js-buy-tiles-icon');
    var iconAnimation = new vivus__WEBPACK_IMPORTED_MODULE_0___default.a(icon, {
      start: 'manual',
      type: 'scenario',
...
var divAll = document.querySelectorAll('.js-div');

var showDiv = function showDiv(secs) {
  var randomElement = divAll[Math.floor(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0, divAll.length))];
  var tll = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
  randomElement.innerHTML = texts[Math.floor(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0, texts.length))];
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(randomElement, {
    position: 'absolute',
    top: 'random(0, 90)' + '%',
    left: 'random(0, 90)' + '%',
    zIndex: 999,
    pointerEvents: 'none',
    color: colors[Math.floor(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0, colors.length))],
    fontSize: 25,
...
var dogeImg = document.querySelector('.js-doge-img');

if (dogeImg) {
  dogeImg.addEventListener('mousemove', function () {
    showDiv(1);
    console.warn(texts[Math.floor(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0, texts.length))]);
  });
  dogeImg.addEventListener('touchmove', function () {
    showDiv(1);
    console.warn(texts[Math.floor(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0, texts.length))]);
  });
}
...
/***/ "./web/src/js/scripts/loadMore.js":
/*!****************************************!*\
  !*** ./web/src/js/scripts/loadMore.js ***!
  \****************************************/
/*! no exports provided */
...
var loadMoreHld = document.querySelectorAll('.js-load-more-hld');

if (loadMoreHld) {
  loadMoreHld.forEach(function (hld) {
    var itemAll = hld.querySelectorAll('.js-load-more-item');
    var loadMoreBtn = hld.querySelector('.js-load-more-btn');
    var itemDataMax = hld.querySelector('.js-load-more-item').dataset.maxItems;
    var itemDataLoadItems = hld.querySelector('.js-load-more-item').dataset.loadItems;
    var maxItems = itemDataMax ? itemDataMax : 3;
    var loadItems = itemDataLoadItems ? itemDataLoadItems : 2;
    itemAll.forEach(function (item, index, originalArray) {
      if (index > maxItems - 1) {
      ...
      if (maxItems >= originalArray.length) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(loadMoreBtn, {
          display: 'none',
          autoAlpha: 0
        });
      }
    ...
    loadMoreBtn.addEventListener('click', function () {
      ...
      itemAll.forEach(function (item, index, originalArray) {
        ...
        if (loadItems >= originalArray.length) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(loadMoreBtn, {
            display: 'none',
            autoAlpha: 0
          });
        }
...
/***/ "./web/src/js/scripts/partnersFilters.js":
/*!***********************************************!*\
  !*** ./web/src/js/scripts/partnersFilters.js ***!
  \***********************************************/
/*! no static exports found */
...
var partnersFiltersHld = document.querySelector('.js-partners-filters-hld');

if (partnersFiltersHld) {
  var itemAll = partnersFiltersHld.querySelectorAll('.js-partners-filters-item');
  var filterAll = partnersFiltersHld.querySelectorAll('.js-partners-filters-filter');
  var activeFilterAll = partnersFiltersHld.querySelectorAll('.js-partners-filters-active');
  var activeFilterEverything = partnersFiltersHld.querySelector('.js-partners-filters-active-everything');
  var filterEverything = partnersFiltersHld.querySelector('.js-partners-filters-filter-everything');
  var btnApplyFilter = partnersFiltersHld.querySelector('.js-partners-filters-apply-btn');
  var btnResetFilter = partnersFiltersHld.querySelector('.js-partners-filters-reset-btn');
  var resultsNumber = partnersFiltersHld.querySelector('.js-partners-filters-results-number');

  var scrollToFiltersTop = function scrollToFiltersTop() {
    window.scrollTo({
  ...
  filterEverything.addEventListener('click', function () {
    if (!filterEverything.classList.contains('is-active')) {
      // // Reset isActive state for filters
      filterAll.forEach(function (filter) {
  ...
  filterAll.forEach(function (filter) {
    var filterDataCategory = filter.dataset.category;
    filter.addEventListener('click', function () {
      ...
      if (!filter.classList.contains('is-active')) {
        filter.classList.add('is-active'); // Activate checked filter
        ...
        var atLeastOneIsActive = false;
        filterAll.forEach(function (f) {
  ...
  btnApplyFilter.addEventListener('click', function () {
    ...
    activeFilterAll.forEach(function (activeFilter) {
      var activeFilterDataCategory = activeFilter.dataset.category;
...
/* harmony import */ var _libs_lazyLoad__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/lazyLoad */ "./web/src/js/libs/lazyLoad.js");
...
swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["EffectFade"], swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]]); // Import Lazyload for looped sliders to avoid image jumping


var exmapleSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"]('.js-example-slider', {
  slidesPerView: 2,
  spaceBetween: 20,
  loop: true,
  on: {
    slideChange: function slideChange() {
      _libs_lazyLoad__WEBPACK_IMPORTED_MODULE_1__["lazyLoadInstance"].update();
    }
  }
});
exmapleSlider;
var exmapleSlider2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"]('.js-example-slider-2', {
  slidesPerView: 3,
  spaceBetween: 20
});
exmapleSlider2;
